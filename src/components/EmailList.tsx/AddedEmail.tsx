...
export default function AddedEmail({ onRemove, email }: { onRemove: Function, email: string }) {
    return (
        <Container mb={'xs'} style={{ overflow:'hidden',display: 'flex', alignContent: 'center', backgroundColor: 'rgb(44, 46, 51)', border: '1px rgb(53, 58, 60) solid', width: '225px', borderRadius: '100px', overflowX: 'hidden' }}>
